 ...
 * @returns {string}
 */
export function debug_address_to_pubkey(address_string) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(address_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.debug_address_to_pubkey(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function debug_can_decrypt(encrypted_hex, private_key_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.debug_can_decrypt(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
/**
 * @param {string} receiver_address_string
 * @param {string} message
 * @returns {EncryptedMessage}
 */
export function encrypt_message(receiver_address_string, message) {
    const ptr0 = passStringToWasm0(receiver_address_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
/**
 * @param {EncryptedMessage} encrypted_message
 * @param {PrivateKey} receiver_wallet_sk
 * @returns {string}
 */
export function decrypt_message(encrypted_message, receiver_wallet_sk) {
    let deferred4_0;
    let deferred4_1;
    try {
        _assertClass(encrypted_message, EncryptedMessage);
        var ptr0 = encrypted_message.__destroy_into_raw();
        _assertClass(receiver_wallet_sk, PrivateKey);
        var ptr1 = receiver_wallet_sk.__destroy_into_raw();
        const ret = wasm.decrypt_message(ptr0, ptr1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function decrypt_message_with_bytes(encrypted_message, private_key_bytes) {
    let deferred4_0;
    let deferred4_1;
    try {
        _assertClass(encrypted_message, EncryptedMessage);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.decrypt_message_with_bytes(ptr0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function decrypt_with_secret_key(encrypted_message, secret_key_bytes) {
    let deferred4_0;
    let deferred4_1;
    try {
        _assertClass(encrypted_message, EncryptedMessage);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.decrypt_with_secret_key(ptr0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
export class EncryptedMessage {
     ...
     * @returns {EncryptedMessage}
     */
    static new(ciphertext, nonce, ephemeral_public_key) {
        const ptr0 = passArray8ToWasm0(ciphertext, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(nonce, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(ephemeral_public_key, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.encryptedmessage_new(ptr0, len0, ptr1, len1, ptr2, len2);
     ...
     */
    to_bytes() {
        const ret = wasm.encryptedmessage_to_bytes(this.__wbg_ptr);
    ...
    static from_bytes(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.encryptedmessage_from_bytes(ptr0, len0);
        return EncryptedMessage.__wrap(ret);
    }
    /**
     * @returns {string}
    ...
    to_hex() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.encryptedmessage_to_hex(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor(hex) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.encryptedmessage_from_hex(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cipher_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
