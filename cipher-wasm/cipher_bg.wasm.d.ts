...
export const encryptedmessage_new: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
export const encryptedmessage_to_bytes: (a: number) => [number, number];
export const encryptedmessage_from_bytes: (a: number, b: number) => number;
export const encryptedmessage_to_hex: (a: number) => [number, number];
export const encryptedmessage_from_hex: (a: number, b: number) => number;
export const debug_address_to_pubkey: (a: number, b: number) => [number, number, number, number];
export const debug_can_decrypt: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const encrypt_message: (a: number, b: number, c: number, d: number) => [number, number, number];
export const decrypt_message: (a: number, b: number) => [number, number, number, number];
export const decrypt_message_with_bytes: (a: number, b: number, c: number) => [number, number, number, number];
export const decrypt_with_secret_key: (a: number, b: number, c: number) => [number, number, number, number];
