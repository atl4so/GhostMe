  ...
  return (
    <div style={{ 
      ...
      <div style={{ marginBottom: "20px" }}>
        <h3 style={{ color: "#90cdf4", marginTop: 0 }}>How Decryption Works:</h3>
        <ol style={{ padding: "0 0 0 20px", margin: 0 }}>
          <li>We use your wallet's private key to decrypt messages sent to your address</li>
          <li>The decryption process needs the ephemeral public key and nonce from the encrypted message</li>
          <li>A shared secret is derived using your private key and the sender's ephemeral public key</li>
          <li>This shared secret is used to decrypt the message with ChaCha20Poly1305</li>
        </ol>
      </div>
      ...
      <div>
        <div style={{ marginBottom: "15px" }}>
          <label htmlFor="testMessage" style={{ 
            display: "block",
            marginBottom: "5px",
            fontWeight: "bold",
            color: "#90cdf4"
        ...
        <div style={{ 
          ...
          <button 
            ...
            style={{
              ...
              background: "#718096",
              color: "white",
              opacity: (!walletStore.unlockedWallet || !encryptedHex) ? "0.5" : "1"
            }}
          >
            Test Decryption
          </button>
          ...
          <button 
            ...
            style={{
              ...
              background: "#48bb78",
              color: "white",
              opacity: (!walletStore.unlockedWallet || !walletStore.address) ? "0.5" : "1"
            }}
          >
            Test Full Cycle
          </button>
